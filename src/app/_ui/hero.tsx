    ...
    return (
        <div className="py-10 desktop:py-24 align-middle flex flex-col desktop:flex-row px-[var(--px-sm)] desktop:px-[var(--px)] h-1/3 bg-[var(--color-fourth)] ">
            <div className="laptop:p-10 justify-center laptop:justify-normal">
                <h1 className="px-5 py-2 w-fit rounded-lg text-xl laptop:text-4xl font-bold tracking-tight text-[var(--color-secondary)] bg-[var(--color-primary-2)] sm:text-6xl">RePet</h1>
                <p className="mt-6 text-md text-bold laptop:text-2xl laptop:leading-8">Where Love Means no Surprises</p>
                <p className="mt-6 text-sm laptop:text-md laptop:leading-8 laptop:text-justify">At RePet, we bring the joy of beloved pets back into your life through cutting-edge cloning techniques</p>
            </div>
