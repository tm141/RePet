            ...
            <div className="bg-[var(--color-fourth)] rounded-3xl p-5 mt-10">
                ...
                <div className="flex flex-col py-10 testimonial:flex-row laptop:align-middle">
                    ...
                    <div className="laptop:pl-5 flex flex-col justify-center">
                        ...
                        <p className="leading-5 text-sm desktop:text-xl laptop:leading-6 laptop:tracking-wide pb-5 items-center">
                            Sheperd, our distinguished Chief Scientist at Repet, embarked on a professional journey driven by a relentless pursuit of excellence. Armed with a profound understanding of science and a passion for advancing pet care, Sheperd brings unparalleled expertise to our team. Inspired by Repet's mission to prevent the pain of pet loss, Sheperd's innovative contributions play a pivotal role in shaping cutting-edge solutions. As Chief Scientist, Sheperd is dedicated to pushing the boundaries of technology and compassion, ensuring Repet remains at the forefront of revolutionizing the pet care industry and preserving the enduring bonds between pets and their families.
                        </p>
                    </div>
                </div>
                <div className="flex flex-col py-10 testimonial:flex-row laptop:align-middle">
